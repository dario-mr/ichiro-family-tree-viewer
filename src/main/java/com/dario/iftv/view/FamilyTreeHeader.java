...
public class FamilyTreeHeader extends VerticalLayout {
    ...
    public FamilyTreeHeader(TreeGrid<Dog> dogGrid, Function<Integer, Void> updateTreeFunction) {
        ...
        IntegerField generationsInput = new IntegerField("Generations", 5, event -> updateTreeFunction.apply(event.getValue()));
        ...
        HorizontalLayout row = new HorizontalLayout(generationsInput, expand, collapse);
